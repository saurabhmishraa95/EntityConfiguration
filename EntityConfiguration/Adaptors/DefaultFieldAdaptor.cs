...
{
    public class DefaultFieldAdaptor : IDefaultFieldAdaptor
    {
        static HttpClient client = new HttpClient();

        public DefaultFieldAdaptor()
        {
        ...
        public async Task<FieldNameSet> GetFieldsAsync(string entityName)
        {
            ...
            HttpResponseMessage response = await client.GetAsync("/API/DefaultFields/"+entityName);
